...
//	var send = document.querySelector("#sendbtn");
	...
	function insertValue(data){
		id.value = dtoObj.markerId;
		px.value = dtoObj.pointX;
		py.value = dtoObj.pointY;
		cate.value = dtoObj.category;
		pn.value = dtoObj.pointName;
		ph.value = dtoObj.phone;
		addr.value = dtoObj.address;
		urldata.value = dtoObj.description;
	}
